    ...
    >
      ...
      >
        <span className="absolute px-1 py-1.5 right-2 bottom-2 md:right-4 md:bottom-4 rounded">
          {copy ? (
            <TbCopyCheckFilled size={16} className="text-orange-600" />
          ) : (
            <FaRegClipboard
              size={16}
              color="black"
        ...
        {copiedHex === hex && (
          <div className="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-orange-500 bg-opacity-50 rounded-lg">
