    ...
    <div className="mx-auto mt-10 flex justify-center px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8">
        <div className="text-center ">
            <h1
                ...
                <span className="block xl:inline"><span className="mb-1 block text-orange-600 dark:text-orange/95">ColorBits </span>
                <span className="bg-gradient-to-r from-indigo-400 to-pink-600 bg-clip-text text-transparent">
                Where Colors Come Alive.
                </span>
                </span>
                <div className="mt-2  text-orange-600 dark:text-orange/95">Dive into a World of Creativity, 
                    ...
                    <span className="relative">Unleash Your Imagination</span>
                    </span>
                </div>
            </h1>
